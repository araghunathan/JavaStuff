...
public class ActivityLoaderActivity extends Activity {
	...
	private void startImplicitActivation() {
        ...
        final Intent baseIntent = new Intent(Intent.ACTION_VIEW, Uri.parse(URL));
		final Intent chooserIntent = Intent.createChooser(baseIntent, CHOOSER_TEXT);
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		if(requestCode == GET_TEXT_REQUEST_CODE && resultCode == RESULT_OK) {
			final String userInput = data.getStringExtra("USER_INPUT");
			if (userInput != null){
