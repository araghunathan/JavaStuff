// LargestTrackerBinaryInsertion.java
...
/**
 * Created by Archana Raghunathan on 9/28/2015.
 */
public class LargestTrackerBinaryInsertion {
    ...
    public LargestTrackerBinaryInsertion(){
        ...
        mListSize = 0;//keeps track of the current list size so we don't have to call size() method to get this
    }
    ...
    List<Integer> getNLargest(int numberOfTopLargestElements){
        synchronized(this) {
            ...
            //this operation can get expensive because the elements are all being added to the front to
...
}// end LargestTrackerBinaryInsertion.java
